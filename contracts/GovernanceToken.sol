...
abstract contract GovernanceToken is ESVSPStorageV1 {
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "ESVSP::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.number, "ESVSP::_writeCheckpoint: block number exceeds 32 bits");
    ...
    function safe32(uint256 n, string memory errorMessage) private pure returns (uint32) {
