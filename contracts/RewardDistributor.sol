...
contract RewardDistributor is Initializable, ReentrancyGuard, RewardsStorage {
    string public constant VERSION = "1.0.0";
    using SafeERC20 for IERC20;

    /**
     * @dev Called by proxy to initialize this contract
     * @param _locker Vesper pool address
     * @param _rewardTokens Array of reward token addresses
     */
    function initialize(address _locker, address[] memory _rewardTokens) public initializer {
        require(_locker != address(0), "pool-address-is-zero");
